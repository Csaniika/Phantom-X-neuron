...
class BioloidController
{
  public:
	...
	void setNextPose2(int id, int pos);          // set a servo value in the pose_ for kuramoto
    void setId(int index, int id);              // set the id of a particular storage index
    int getId(int index);                       // get the id of a particular storage index                          // get the pose in from the servos 
    /* Pose Engine */
